...
Este script:
1. Carga datos limpios del protocolo de selección
2. Entrena modelos Prophet para cada variable seleccionada
3. Guarda los modelos entrenados
"""
...
def main():
    print("="*80)
    print("ENTRENAMIENTO DE DETECTOR DE ANOMALÍAS CON PROPHET")
    print("="*80)
    ...
    # Limitar número de variables para entrenamiento inicial (opcional)
    # Puedes ajustar esto según tus necesidades
    max_variables = 50  # Entrenar máximo 50 variables inicialmente
    if len(variables) > max_variables:
        print(f"\n[ADVERTENCIA] {len(variables)} variables encontradas.")
        print(f"   Entrenando las primeras {max_variables} variables.")
        print(f"   Para entrenar todas, ajusta 'max_variables' en el script.")
    ...
    detector = ProphetAnomalyDetector(
        ...
        yearly_seasonality=False,      # No estacionalidad anual (datos mensuales)
