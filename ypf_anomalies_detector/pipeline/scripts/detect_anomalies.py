...
Este script:
1. Carga modelos Prophet previamente entrenados
2. Detecta anomalías en nuevos datos
3. Genera reportes y visualizaciones
"""
...
def main():
    print("="*80)
    print("DETECCIÓN DE ANOMALÍAS CON PROPHET")
    print("="*80)
    ...
    # Anomalías por fecha
    if datetime_col in combined_results.columns:
